                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" style="margin: 0;">
                        ...
                        <tbody>
                            ...
                            <!-- Isi tabel dengan data dari URL JSON menu -->
                            @foreach ($data['menu'] as $menuItem)
                            <tr>
                                <td>{{ $menuItem['nama_menu'] }}</td>
                                <!-- Masukkan data lain yang Anda ingin tampilkan di sini -->
                            </tr>
                            @endforeach
                            <!-- Isi tabel dengan data dari URL JSON transaksi -->
                            @foreach ($data['transaksi'] as $transaksiItem)
                            <tr>
                                <td>{{ $transaksiItem['nama_menu'] }}</td>
                                <!-- Masukkan data lain yang Anda ingin tampilkan di sini -->
                            </tr>
                            @endforeach
                        </tbody>
