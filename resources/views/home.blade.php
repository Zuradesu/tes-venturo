            ...
            <li>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_menu" value="{{ $menuItem['menu'] }}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="harga">Harga</label>
                        <input type="text" class="form-control" id="harga" value="{{ $menuItem['kategori'] }}" readonly>
                    </div>
                    <!-- Tambahkan lebih banyak elemen formulir sesuai dengan data JSON yang Anda miliki -->
                ...
                <form action="" method="get">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <a href="tugas" rel="Array Transaksi" class="btn btn-secondary">
                                Halaman Tugas
                            </a>
                        </div>
                    </div>
